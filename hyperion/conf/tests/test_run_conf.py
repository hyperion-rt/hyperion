...
def test_propagate_check_frequency(value):
    r = RunConf()
    r.set_propagate_check_frequency(value)


@pytest.mark.parametrize(('value'), [[1, 2, 3], 'hello', (1, 2)])
def test_propagate_check_frequency_invalid1(value):
    r = RunConf()
...
def test_propagate_check_frequency_invalid2(value):
    r = RunConf()
